...
if __name__ == '__main__':
    ...
    chosen, costs, profits = board_generator(deepcopy(multiplex), graphs, good_nodes, l=budget,
    ...
    seed_set = get_seedset(deepcopy(multiplex), graphs, good_nodes, budget_layers, args.thresold,
                           diffusion=args.diffusion_model)
